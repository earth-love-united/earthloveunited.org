...
| `fossil_co2_mt` | No year, boundary, method, source record, or citation | Reviewed Global Carbon Budget fossil CO₂ observation with year, units, territorial boundary, transformation, checksum, and citation | Retired / blocked; replacement pipeline pending |
| `lulucf_co2_mt` | No year, sign convention, land-use boundary, method, or citation | Separately reviewed Global Carbon Budget land-use CO₂ observation with sign convention and uncertainty disclosed | Retired / blocked; replacement pipeline pending |
