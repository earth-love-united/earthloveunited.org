...
const _FALLBACK_SITES = [
  {id:"sri_lanka",name:"Northern Province",subtitle:"Multilayer Afforestation · Sri Lanka",lat:9.666,lng:80.285,primaryBiome:"tropical_dry_forest",currentBiome:"degraded_bare_land",area:2428,
    ...
    connection:"SPE's flagship — reportedly approved by the Governor of Northern Province (independent verification pending), land confirmed across Jaffna, Vavuniya, Mullaitivu, Mannar, and Kilinochchi."},
  ...
  {id:"benin",name:"Ouidah Wetlands",subtitle:"Mangrove Degradation · Benin",lat:6.35,lng:2.10,primaryBiome:"mangrove",currentBiome:"degraded_bare_land",area:2500,
    narrative:"Jean Missinhoun, founder of Earth Love United, carried this mangrove project in his heart until his passing (date unverified). The Ouidah lagoons once held dense mangroves — the most carbon-dense ecosystems on Earth. Restoring them continues his vision.",
    ...
    connection:"Continuing his mangrove restoration vision in Benin.",
  },
...
const KB = {
  ...
  emissions:()=>`<p>Latest data from Global Carbon Budget 2025, NOAA, and OWID:</p><div class="data-card" style="margin-top:6px"><div class="dc-row"><span class="dc-label">Fossil CO₂ (2025)</span><span class="dc-value warn">~37,400 Mt CO₂ (~10.3 GtC)</span></div><div class="dc-row"><span class="dc-label">Land use change</span><span class="dc-value warn">~4,800 Mt CO₂</span></div><div class="dc-row"><span class="dc-label">Total human</span><span class="dc-value warn">~42.2 Gt CO₂/yr</span></div><div class="dc-row"><span class="dc-label">Ocean sink</span><span class="dc-value">~10 GtC/yr absorbed</span></div><div class="dc-row"><span class="dc-label">Land sink</span><span class="dc-value">~12 GtC/yr absorbed</span></div><div class="dc-row"><span class="dc-label">Net atmospheric growth</span><span class="dc-value warn">~20 Gt CO₂/yr</span></div></div><p style="margin-top:6px"><strong>By fuel:</strong> Coal 40.7% · Oil 32.3% · Gas 20.9% · Cement 4.2%</p><p><strong>By sector:</strong> Electricity & heat 38% · Transport 24% · Industry 21% · Buildings 9%</p><p style="margin-top:5px">About half of emitted CO₂ stays in the atmosphere. The rest is absorbed by oceans and land sinks — but their capacity is not unlimited.</p><p style="margin-top:5px;font-size:10px;color:var(--teal)">Source: Friedlingstein et al 2026, Global Carbon Budget 2025</p>`,
  ...
  carbon_budget:()=>`<p>How much more CO₂ can we emit? (IPCC AR6, Global Carbon Budget 2025, Friedlingstein et al 2026)</p><div class="data-card" style="margin-top:6px"><div class="dc-row"><span class="dc-label">For 1.5°C (50%)</span><span class="dc-value warn">~170 Gt CO₂ remaining</span></div><div class="dc-row"><span class="dc-label">For 2.0°C (50%)</span><span class="dc-value">~1,150 Gt CO₂ remaining</span></div><div class="dc-row"><span class="dc-label">Current rate</span><span class="dc-value warn">~42 Gt CO₂/yr</span></div><div class="dc-row"><span class="dc-label">1.5°C budget gone</span><span class="dc-value warn">~2030</span></div><div class="dc-row"><span class="dc-label">2.0°C budget gone</span><span class="dc-value">~2052</span></div></div><p style="margin-top:6px">Every fraction of a degree matters. Every year matters. Every ton of CO₂ matters.</p><p style="margin-top:5px">1,000 Gt CO₂ emitted ≈ 0.45°C warming (Transient Climate Response to Cumulative Emissions).</p>`,
  ...
  jean:()=>{const s=_sites[2];return `<p>Jean Missinhoun (dates unverified) founded Earth Love United and championed the Benin mangrove restoration. He went from oil to earth — dedicating his life to environmental restoration.</p><div class="data-card" style="margin-top:6px"><div class="dc-header"><span class="dc-icon">💚</span><span class="dc-title">Jean's Legacy</span></div><div class="dc-row"><span class="dc-label">Project</span><span class="dc-value leaf">Ouidah Mangrove Restoration, Benin</span></div><div class="dc-row"><span class="dc-label">Goal</span><span class="dc-value leaf">Restore the most carbon-dense ecosystems on Earth</span></div><div class="dc-row"><span class="dc-label">Carbon density</span><span class="dc-value leaf">950 tC/ha</span></div><div class="dc-row"><span class="dc-label">Area</span><span class="dc-value">${s.area.toLocaleString()} ha</span></div></div><p style="margin-top:6px">His team continues the work — now the mangroves have a chance to return.</p><p style="margin-top:5px;font-style:italic;color:var(--text3)">"From oil to earth" — Jean's journey is our journey.</p>`;},
...
Human emissions: ~42.2 Gt CO2/year (total)
Nature absorbs: ~22 Gt CO2/year (net sink)
Net excess: ~20 Gt CO2/year (accumulating)
Carbon budget for 1.5C: ~170 Gt remaining (~4 years at current rate)
...
function getLiveData() {
  ...
  return {
    ...
    humanEmissions: { annualGt: 42.2, dailyGt: 0.116, hourlyGt: 0.0048, natureAbsorptionGt: 22, netExcessGt: 20 },
    carbonBudget: { remaining15: 170, remaining20: 1150, yearsLeft15: 4, yearsLeft20: 27 },
  };
}
...
function generateGlobalOutlook() {
  ...
  if (budget.yearsLeft15 !== undefined) {
    ...
    html += `<div style="margin:8px 0 4px"><span style="font-size:11px;color:var(--text3)">1.5°C budget (~170 Gt CO₂ remaining)</span></div>`;
    html += GAIA_CHARTS.countdownBarHTML(budget.remaining15, 170, 220, { label: `~${budget.yearsLeft15} years left` });
...
function generateCarbonBudget() {
  ...
  if (budget.yearsLeft15 !== undefined) {
    ...
    extra += GAIA_CHARTS.countdownBarHTML(budget.remaining15, 170, 220, { label: `~${budget.yearsLeft15} years at current rate` });
