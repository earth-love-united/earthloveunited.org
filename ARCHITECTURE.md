...
`sw.js` cache epoch v65 precaches the public page, core CSS/JS, the refined
three-move Climate Intelligence first orbit with separately spaced visual cue lanes and a compact lens/card gutter, the shared raised-tile lenses, evidence-only
