...
const PATHS = Object.freeze({
  ...
  build_factual_public: 'tools/build-factual-public-deploy.sh',
  ...
  final_factual_integrity: 'tools/check-staged-factual-public-integrity.js',
...
module.exports = { assetRecord, assertSafeStagedPath, inspectServiceWorker, loadInput, parseIndexRuntimeRequests, parseNavigationPoints, parseRuntimeConfig, resolveStagedRoot, verifyStaged };
