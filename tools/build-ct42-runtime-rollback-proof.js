...
function neutralIndex(bytes) {
  ...
  index = replaceOnce(index, '<link rel="stylesheet" href="css/guided-first-orbit.css?v=v9">\n', '', 'remove guided orbit CSS');
  ...
  index = replaceOnce(index, 'href="css/globe-system.css?v=v42"', 'href="css/globe-system.css?v=ct42-neutral-rollback-1"', 'rollback CSS key');
  index = replaceOnce(index, 'href="js/data.js?v=v10" as="script"', 'href="js/data.js?v=ct42-neutral-rollback-1" as="script"', 'rollback data preload key');
  index = replaceOnce(index, 'src="js/data.js?v=v10"', 'src="js/data.js?v=ct42-neutral-rollback-1"', 'rollback data key');
  index = replaceOnce(index, '<script src="js/country-climate-intelligence.js?v=v13"></script>\n', '', 'remove Climate Intelligence runtime');
  index = replaceOnce(index, 'src="js/globe.js?v=v37"', 'src="js/globe.js?v=ct42-neutral-rollback-1"', 'rollback globe key');
...
`,
  ...
  index = replaceOnce(index, "navigator.serviceWorker.register('/sw.js?v=69-runtime-resilience'", `navigator.serviceWorker.register('${SERVICE_WORKER_REGISTRATION}'`, 'rollback service worker registration');
...
const CACHE_NAME = '${CACHE_NAME}';`,
  ...
  sw = replaceOnce(sw, "'/js/data.js?v=v10'", "'/js/data.js?v=ct42-neutral-rollback-1'", 'rollback data precache');
  sw = replaceOnce(sw, "'/js/globe.js?v=v37'", "'/js/globe.js?v=ct42-neutral-rollback-1'", 'rollback globe precache');
