...
function neutralIndex(bytes) {
  ...
  index = replaceOnce(index, 'href="css/globe-system.css?v=v41"', 'href="css/globe-system.css?v=ct42-neutral-rollback-1"', 'rollback CSS key');
...
`,
  ...
  index = replaceOnce(index, "navigator.serviceWorker.register('/sw.js?v=66-card-lens-air'", `navigator.serviceWorker.register('${SERVICE_WORKER_REGISTRATION}'`, 'rollback service worker registration');
...
const CACHE_NAME = '${CACHE_NAME}';`,
  ...
  sw = replaceOnce(sw, "'/css/globe-system.css?v=v41'", "'/css/globe-system.css?v=ct42-neutral-rollback-1'", 'rollback CSS precache');
