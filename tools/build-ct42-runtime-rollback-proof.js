...
const CACHE_NAME = '${CACHE_NAME}';`,
  ...
  sw = replaceOnce(sw, "'/css/globe-system.css?v=v43'", "'/css/globe-system.css?v=ct42-neutral-rollback-1'", 'rollback CSS precache');
  sw = replaceOnce(sw, "'/js/data.js?v=v16'", "'/js/data.js?v=ct42-neutral-rollback-1'", 'rollback data precache');
  sw = replaceOnce(sw, "'/js/globe.js?v=v40'", "'/js/globe.js?v=ct42-neutral-rollback-1'", 'rollback globe precache');
