...
const manifest = {
  ...
  source_checksums: audit.documents.map(document => ({
    ...
    checksum_sha256: document.raw_file_acquisition.checksum_sha256,
    checksum_state: document.raw_file_acquisition.state,
    reason_codes: document.raw_file_acquisition.reason_codes,
    content_locator_verification_state: document.content_locator_verification.state,
    content_locator_verification_channel: document.content_locator_verification.channel,
  })),
  review: audit.review,
