...
const climateIntelligenceCache = serviceWorker.includes("const CACHE_NAME = 'elu-v77-cci-raw-byte-boundary'") &&
  serviceWorker.includes("'/data/climate/runtime/country-climate-intelligence.json?v=cci1runtime13'") &&
  serviceWorker.includes("'/js/country-climate-intelligence.js?v=v17'") && hasClimateIntelligenceLegend;
...
if (!index.includes("navigator.serviceWorker.register('/sw.js?v=26'") &&
    ...
    !index.includes("navigator.serviceWorker.register('/sw.js?v=77-cci-raw-byte-boundary'")) {
