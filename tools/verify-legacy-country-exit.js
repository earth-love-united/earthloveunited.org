...
const climateIntelligenceCache = serviceWorker.includes("const CACHE_NAME = 'elu-v72-tutorial-lens-clear'") &&
  serviceWorker.includes("'/data/climate/runtime/country-climate-intelligence.json?v=cci1candidate8'") &&
  serviceWorker.includes("'/js/country-climate-intelligence.js?v=v14'") && hasClimateIntelligenceLegend;
...
if (!index.includes("navigator.serviceWorker.register('/sw.js?v=26'") &&
    ...
    !index.includes("navigator.serviceWorker.register('/sw.js?v=72-tutorial-lens-clear'")) {
