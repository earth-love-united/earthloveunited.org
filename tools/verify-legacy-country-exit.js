...
const climateIntelligenceCache = serviceWorker.includes("const CACHE_NAME = 'elu-v79-self-hosted-fonts'") &&
...
if (!index.includes("navigator.serviceWorker.register('/sw.js?v=26'") &&
    ...
    !index.includes("navigator.serviceWorker.register('/sw.js?v=79-self-hosted-fonts'")) {
