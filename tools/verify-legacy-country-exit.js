...
const climateIntelligenceCache = serviceWorker.includes("const CACHE_NAME = 'elu-v64-orbit-cue-spacing'") &&
...
if (!index.includes("navigator.serviceWorker.register('/sw.js?v=26'") &&
    ...
    !index.includes("navigator.serviceWorker.register('/sw.js?v=64-orbit-cue-spacing'")) {
