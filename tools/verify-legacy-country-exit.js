...
const climateIntelligenceCache = serviceWorker.includes("const CACHE_NAME = 'elu-v78-first-paint-ready'") &&
...
if (!index.includes("navigator.serviceWorker.register('/sw.js?v=26'") &&
    ...
    !index.includes("navigator.serviceWorker.register('/sw.js?v=78-first-paint-ready'")) {
