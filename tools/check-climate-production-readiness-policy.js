...
const candidate = {
  ...
  ct40: {
    decision_scope: 'assessed_climate_release', decision: 'deny', eligible: false, content_eligible: false,
    factual_publication_eligible: true, magnitude_comparison_eligible: true,
    commitment_display_status: 'not_present', derived_metrics_status: 'not_present',
    performance_assessment_status: 'not_present', score_status: 'not_present',
    release_authority: false, reason_codes: ['evidence_insufficient'],
  },
  ...
  artifacts: { runtime_manifest: false, release_input: false, release_diff: false, allow_manifest: false, rollback_proof: false },
...
const release = {
  ...
  javascript_syntax_passed: true,
  ct40: {
    decision_scope: 'assessed_climate_release', decision: 'allow', eligible: true, content_eligible: true,
    factual_publication_eligible: true, magnitude_comparison_eligible: true,
    commitment_display_status: 'eligible', derived_metrics_status: 'eligible',
    performance_assessment_status: 'eligible', score_status: 'eligible',
    release_authority: false, reason_codes: [],
  },
  ...
  artifacts: { runtime_manifest: true, release_input: true, release_diff: true, allow_manifest: true, rollback_proof: true },
...
const candidateMutations = [
  ...
  input => { input.ct40.decision_scope = 'generic_release'; },
  input => { input.ct40.content_eligible = true; },
  input => { input.ct40.factual_publication_eligible = false; },
  input => { input.ct40.magnitude_comparison_eligible = false; },
  input => { input.ct40.commitment_display_status = 'eligible'; },
  input => { input.ct40.derived_metrics_status = 'eligible'; },
  input => { input.ct40.performance_assessment_status = 'eligible'; },
  input => { input.ct40.score_status = 'eligible'; },
  ...
  input => { input.artifacts.release_input = true; },
  input => { input.artifacts.release_diff = true; },
  input => { input.artifacts.allow_manifest = true; },
  input => { input.reviewed_release.status = 'validated'; },
...
const releaseMutations = [
  ...
  input => { input.reviewed_release.rollback_proof_passed = false; },
  ...
  input => { input.artifacts.release_input = false; },
