...
function evaluateRuntimeAssets(input) {
  ...
  check('service-worker-epoch', sw.includes("const CACHE_NAME = 'elu-v55-power-signature';") && files.index.includes("navigator.serviceWorker.register('/sw.js?v=55-power-signature'"),
