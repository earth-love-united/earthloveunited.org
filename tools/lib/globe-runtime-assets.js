...
const EXPECTED_UI_REVIEW_COMMIT = 'bd5b6ef63df2ba17103e78351aedf677fb2d339f';
const EXPECTED_UI_REVIEW_SHA256 = 'e8beae7b1f83b15f41f00dad77e1b21f098a8d31fae0b147fa4b1023803862e3';
...
function evaluateRuntimeAssets(input) {
  ...
  check('service-worker-epoch', sw.includes("const CACHE_NAME = 'elu-v36-dock-review';") && files.index.includes("navigator.serviceWorker.register('/sw.js?v=36-dock-review'"),
