...
function evaluateRuntimeAssets(input) {
  ...
  check('service-worker-epoch', sw.includes("const CACHE_NAME = 'elu-v56-power-field';") && files.index.includes("navigator.serviceWorker.register('/sw.js?v=56-power-field'"),
