...
function evaluateRuntimeAssets(input) {
  ...
  check('service-worker-epoch', sw.includes("const CACHE_NAME = 'elu-v65-card-lens-gutter';") && files.index.includes("navigator.serviceWorker.register('/sw.js?v=65-card-lens-gutter'"),
