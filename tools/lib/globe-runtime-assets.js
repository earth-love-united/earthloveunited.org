...
function evaluateRuntimeAssets(input) {
  ...
  check('service-worker-epoch', sw.includes("const CACHE_NAME = 'elu-v58-power-palette';") && files.index.includes("navigator.serviceWorker.register('/sw.js?v=58-power-palette'"),
