...
function evaluateRuntimeAssets(input) {
  ...
  check('service-worker-epoch', sw.includes("const CACHE_NAME = 'elu-v48-globe-lifecycle';") && files.index.includes("navigator.serviceWorker.register('/sw.js?v=48-globe-lifecycle'"),
