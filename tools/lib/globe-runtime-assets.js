...
function evaluateRuntimeAssets(input) {
  ...
  check('service-worker-epoch', sw.includes("const CACHE_NAME = 'elu-v53-red-team-fixes';") && files.index.includes("navigator.serviceWorker.register('/sw.js?v=53-red-team-fixes'"),
