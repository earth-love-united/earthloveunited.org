...
function evaluateRuntimeAssets(input) {
  ...
  check('service-worker-epoch', sw.includes("const CACHE_NAME = 'elu-v66-card-lens-air';") && files.index.includes("navigator.serviceWorker.register('/sw.js?v=66-card-lens-air'"),
